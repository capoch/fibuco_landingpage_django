...
if not settings.DEBUG:
    ...
    SECRET_KEY = '9iz^ef0u!tj7+0e6*ii5rwd-a+yv6m^l(kdnni&lx(xp@2t)sa'

    # SECURITY WARNING: don't run with debug turned on in production!
    DEBUG = False

    ADMINS =(("Philipp","buemplizer@gmail.com"),)

    ALLOWED_HOSTS = ['capoch.webfactional.com']
    EMAIL_HOST = 'smtp.gmail.com'
    EMAIL_HOST_USER = 'buemplizer@gmail.com'
    EMAIL_HOST_PASSWORD = '5t4r6uck5'
    EMAIL_PORT = 587
    EMAIL_USE_TLS = True
    ...
    STATIC_ROOT = '/home/capoch/webapps/fibuco_static/'
    ...
    MEDIA_URL = '/media/'
    MEDIA_ROOT = '/home/capoch/webapps/fibuco_media/'
